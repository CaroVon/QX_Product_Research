import {
  ...
  shift,
  size
} from "./chunk-XKHA627Q.js";
import {
  useCurrentEditor
} from "./chunk-66OTBMP5.js";
import {
  require_react_dom
...
function useMenuElementProps(element, props) {
  const previousPropsRef = (0, import_react3.useRef)({});
  const listenersRef = (0, import_react3.useRef)([]);
...
var BubbleMenu2 = import_react2.default.forwardRef(
  ({
    ...
    const resolvedPluginKey = (0, import_react2.useRef)(getAutoPluginKey(pluginKey, "bubbleMenu")).current;
...
var FloatingMenu2 = import_react5.default.forwardRef(
